...
if (empty($endereco)) {
    $enderecoErro = 'Por favor digite o endereco!';
    $validacao = false;
}
...
if ($validacao) {
    ...
    $sql = "UPDATE tb_alunos set nome = ?,enderco = ?, fone = ?, email = ?, idade = ? WHERE rm = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($nome, $endereco, $telefone, $email, $idade, $rm));
    Banco::desconectar();
    header("Location: index.php");
}
} else {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal"
                        ...
                        action="update.php?rm=<?php echo $rm ?>" method="post">
...
control" size="80" type="text" placeholder="Endereço"
                        ...
                        <div class="control-group <?php echo
                            ...
                            <div class="controls">
                                ...
                                <input name="fone" class="form-
control" size="30" type="text" placeholder="Telefone"

                                    value="<?php echo !empty($telefone) ?
